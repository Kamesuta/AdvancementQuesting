...
--> statement-breakpoint
DROP TABLE IF EXISTS `quest_proposals`;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `player_quest_unique` ON `player_progress` (`player_uuid`,`quest_id`);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `proposal_player_unique` ON `proposal_votes` (`proposal_id`,`player_uuid`);
--> statement-breakpoint
